set project tic-tac-toe-verilog
...
if {[lindex $argv 0] == "simulation"} {
	launch_simulation
    start_gui
	add_wave {{/testbench/my_example/my_timing/vcount}} {{/testbench/my_example/my_timing/vsync}} {{/testbench/my_example/my_timing/vblnk}} {{/testbench/my_example/my_timing/hcount}} {{/testbench/my_example/my_timing/hsync}} {{/testbench/my_example/my_timing/hblnk}} 
    add_force {/testbench/my_example/my_timing/rst} -radix hex {0 0ns}
	run all
